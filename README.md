...
Before that, I was a PhD Candidate at [MIT AeroAstro](https://aeroastro.mit.edu/) studying aircraft design, multidisciplinary design optimization (MDO), and computational aerodynamics. :rocket: :airplane: I did [my PhD research](https://dspace.mit.edu/handle/1721.1/157809) on developing [new optimization techniques that allow us to quickly solve challenging real-world engineering problems](github.com/peterdsharpe/AeroSandbox). Some general ideas in my work:
...
* Generally, my work focuses on "wide" rather than "deep" design optimization: when designing complex engineering systems, I've found that [it's usually more important to capture the rough design trade-offs across dozens of subsystems, rather than precisely analyzing just one or two disciplines](github.com/peterdsharpe/transport-aircraft). When precision is required, [surrogate modeling techniques based on data from high-fidelity analysis and occasionally machine learning](https://github.com/peterdsharpe/neuralfoil) can allow us to retain both high speed and high accuracy.
